...
if( !isset($_GET['id_warga'])){
    header('Location: index-lihat-data.php');
}
    ...
    <div class="bg-white">
        <div class="flex">
            ...
            <div class="flex-auto w-4/5 px-4 mt-10">
                <h4 class="px-6 font-Poppins text-2xl text-primary">Form Edit Data Warga</h4>
                <div class="py-4 px-6">
                ...
                <div class="px-6">
                    ...
                    <div class="">
                        ...
                        <div class="mt-2">
                            <input type="text" name="nama" id="nama" value="<?php echo $warga['nama'] ?>" required class="input input-bordered input-primary w-4/6 rounded-md">
                        </div>
                    </div>
                    <div class="py-4">
                        <div class="flex">
                        ...
                        <div class="mt-2">
                            <input type="text" name="usia" id="usia" value="<?php echo $warga['usia'] ?>" required class="input input-bordered input-primary w-4/6 rounded-md">
                        </div>
                    </div>
                    <div class="py-4">
                        <div class="flex">
                        ...
                        <div class="mt-2">
                            <input type="text" name="alamat" id="alamat" value="<?php echo $warga['alamat'] ?>" required class="input input-bordered input-primary w-4/6 rounded-md">
                        </div>
                    </div>
                    <div class="py-4">
                        <div class="flex">
                        ...
                        <div class="mt-2">
                            <input type="text" name="no_telp" id="no_telp" value="<?php echo $warga['no_telp'] ?>" required class="input input-bordered input-primary w-4/6 rounded-md">
                        </div>
                    </div>
                    <div class="py-4">
                        <div class="flex">
                        ...
                        <div class="mt-2">
                            <?php $status_warga = $warga['status_warga']?>
                            <select class="select select-bordered select-primary w-4/6" name="status_warga">
                            <option value="" selected>Status</option>
                                <option <?php  echo ($status_warga == 'Sudah Menikah')? "selected": "" ?>>Sudah Menikah</option>
                                <option <?php  echo ($status_warga == 'Belum Menikah')? "selected": "" ?>>Belum Menikah</option>
                            </select>
                        </div>
                    </div>
                    <div class="py-4">
                        ...
                        <div class="mt-2">
                            <input type="text" name="jum_anggota" id="jum_anggota" value="<?php echo $warga['jum_anggota'] ?>" required class="input input-bordered input-primary w-4/6 rounded-md">
                        </div>
                    </div>
                    <div class="py-4">
                        <button type="submit" class="btn btn-outline btn-primary w-64" name="simpan">Simpan</button>
                    </div>
                </div>
                </form>
            </div>
